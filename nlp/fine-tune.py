...
CHECK_POINT_PATH = "mbti-classification/checkpoint-45000"
OUTPUT_DIR = "mbti-classification"
DATA_PATH = "tokenized_datasets"
...
if not os.path.exists(DATA_PATH):
    dataset = load_dataset("echodpp/mbti-cleaned")
...
model = AutoModelForSequenceClassification.from_pretrained(
    MODEL_PATH, num_labels=16, ignore_mismatched_sizes=True)
tokenizer = AutoTokenizer.from_pretrained(TOKENIZER_PATH)
